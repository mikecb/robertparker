...
type Domain struct {
	...
	Suffix    string   `json:",omitempty"` //The domain's publix suffix as defined by publixsuffix.org. Note: public clouds like appspot.com count are a public suffix for these purposes.
	...
	Entropy   float64  `json:",omitempty"` //This might turn into a map if more than one entorpy algorithm were to be implemented.
